...
pytesseract.pytesseract.tesseract_cmd='C:\\Users\\bpash\\AppData\\Local\\Tesseract-OCR\\tesseract.exe'
...
#NOTE:- I downloaded this image from Google,
#if you have any query or problem i can remove it, 
#i just used it for Educational purpose.	